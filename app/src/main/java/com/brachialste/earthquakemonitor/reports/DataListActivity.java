...
//        Utilities.checkLanguage(getApplicationContext());
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case DataManager.DATA_RECEIVED:
                    ...
                    Toast.makeText(DataListActivity.this, getString(R.string.rep_list_upd), Toast.LENGTH_SHORT).show();
                    break;
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.est_bar_menu, menu);
        return true;
    }
    ...
    public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
        ...
        inflater.inflate(R.menu.rep_bar_menu, menu);
        return true;
    }
