...
//        Utilities.checkLanguage(getApplicationContext());
        ...
        if(title != null) {
            ...
            // magnitud
            ((TextView) findViewById(R.id.data_magnitude)).setText(getString(R.string.data_mag) + dataBean.getMagnitude());
            // profundidad
            ((TextView) findViewById(R.id.data_depth)).setText(getString(R.string.data_depth) + dataBean.getDepth() + getString(R.string.data_km));
            // lugar
            ((TextView) findViewById(R.id.data_place)).setText(getString(R.string.data_place) + dataBean.getPlace());
